      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="text-center py-12">
          <div className="mb-8">
            ...
            <h2 className="text-2xl text-gray-700 mb-4">No Plants Yet!</h2>
          ...
          <Link 
            href="/"
            className="inline-flex items-center justify-center bg-green-600 text-white 
              px-6 py-3 rounded-lg hover:bg-green-700 transition-colors duration-300"
          >
