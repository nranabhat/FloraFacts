    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="space-y-12">
        ...
        <section className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg 
          ...
          <h2 className={`${lobster.className} text-2xl text-green-700 dark:text-green-500 mb-4`}>
            The Story
          </h2>
        ...
        {/* Learning Journey */}
        <section className="bg-green-50 dark:bg-gray-800 p-8 rounded-2xl 
          border-2 border-green-100 dark:border-gray-700 transition-colors duration-200">
          <h2 className={`${lobster.className} text-2xl text-green-700 dark:text-green-500 mb-4`}>
            What I&apos;ve Learned
          </h2>
        ...
        <section className="text-center">
          ...
          <div className="flex justify-center gap-4">
            <a 
              ...
              className="bg-green-600 dark:bg-green-700 text-white px-6 py-2 rounded-lg
                hover:bg-green-700 dark:hover:bg-green-600 transition-colors duration-300"
            >
              View on GitHub
            </a>
            <a 
              href="mailto:nicoranabhat@gmail.com"
              className="bg-green-100 dark:bg-gray-700 text-green-800 dark:text-green-400 
                px-6 py-2 rounded-lg hover:bg-green-200 dark:hover:bg-gray-600 
